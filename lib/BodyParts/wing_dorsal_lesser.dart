...
import 'package:birdbrain/BodyParts/scapular.dart';
...
class WingDorsalLesser extends StatefulWidget {
  Map _results;
  File _image;
  WingDorsalLesser(this._results, this._image);
  @override
  _WingDorsalLesserState createState() => _WingDorsalLesserState(_results, _image);
}

class _WingDorsalLesserState extends State<WingDorsalLesser> {
  final FirebaseAuth auth = FirebaseAuth.instance;
  File _image;
  Map _results;
  _WingDorsalLesserState(this._results, this._image);
