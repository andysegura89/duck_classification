...
import 'package:birdbrain/BodyParts/wing_dorsal_lesser.dart';
...
class WingDorsalSecondary extends StatefulWidget {
  Map _results;
  File _image;
  WingDorsalSecondary(this._results, this._image);
  @override
  _WingDorsalSecondaryState createState() => _WingDorsalSecondaryState(_results, _image);
}

class _WingDorsalSecondaryState extends State<WingDorsalSecondary> {
  final FirebaseAuth auth = FirebaseAuth.instance;
  File _image;
  Map _results;
  _WingDorsalSecondaryState(this._results, this._image);
  ...
  classifyImage(File image) async {
    ...
    if (output != null) {
      _results['wing_dorsal_secondary'] = [
        _image,
        output[0]['label'],
        output[0]['confidence']
      ];
    ...
    if (output != null) {
      Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  WingDorsalLesser(_results, _image)));
    }
  }
