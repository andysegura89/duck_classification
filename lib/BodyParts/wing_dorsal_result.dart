...
import 'package:birdbrain/BodyParts/wing_dorsal_secondary.dart';
...
class _WingDorsalResultState extends State<WingDorsalResult> {
  ...
  loadModel() async {
    await Tflite.loadModel(
      model: 'assets/wing_dorsal_model.tflite',
      ...
      body: Container(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              const Text('Back side of the wing:',
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  WingDorsalSecondary(_results, _image)));
                    },
                    child: Container(
                      padding: EdgeInsets.all(20),
                      decoration: BoxDecoration(
