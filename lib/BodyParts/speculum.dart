...
import 'package:birdbrain/BodyParts/wing_ventral.dart';
...
class Speculum extends StatefulWidget {
  Map _results;
  File _image;
  Speculum(this._results, this._image);
  @override
  _SpeculumState createState() => _SpeculumState(_results, _image);
}

class _SpeculumState extends State<Speculum> {
  final FirebaseAuth auth = FirebaseAuth.instance;
  File _image;
  Map _results;
  _SpeculumState(this._results, this._image);
      ...
      body: Container(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Container(
                child: Text('Running model 5 on image'),
              ),
            ],
          ),
        ),
